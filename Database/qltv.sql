...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 29, 2025 lúc 08:53 AM
...
CREATE TABLE `borroweddevices` (
  ...
  `status` enum('Returned','Lost','Not Returned') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `members` (
  `member_id` varchar(10) NOT NULL,
  `full_name` varchar(30) NOT NULL DEFAULT 'DefaultValue',
  `gender` varchar(4) NOT NULL,
  `number_phone` int(11) NOT NULL,
  `dob` date NOT NULL,
  `email` varchar(50) NOT NULL,
  `status` enum('Active','Punished','Banned','') NOT NULL DEFAULT 'Active'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('admin1', 'admin', 'nam', 123456789, '2000-01-11', 'admin1@gmail.com', 'Active'),
('TV112', 'Nguyen Van A', 'Nam', 732183421, '2000-01-02', 'NguyenVanA@gmail.com', 'Active');
